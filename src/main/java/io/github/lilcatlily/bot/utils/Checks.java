...
public class Checks
{
     ...
     *                                      message is formed by replacing each {@code %s} placeholder in the template with
     *                                      an
     ...
     *
     * @param  start
     *                                       a user-supplied index identifying a starting position in an array, list or
     *                                       string
     * @param  end
     *                                       a user-supplied index identifying an ending position in an array, list or
     *                                       string
     * @param  size
     *                                       the size of that array, list or string
     * 
